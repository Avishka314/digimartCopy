          ...
          allProducts = allProducts.map(product => {
            ...
            if (product.images) {
              ...
              if (Array.isArray(imgs) && imgs.length > 0) {
                processedImage = `http://192.168.56.83:5000${imgs[0].path}`;
              }
            }
                            ...
                            uri: (() => {
                              ...
                              if (product.imageUrl) {
                                if (typeof product.imageUrl === 'string' && product.imageUrl.startsWith('http')) {
                                  ...
                                  const fullUrl = `http://192.168.56.83:5000${product.imageUrl.startsWith('/') ? product.imageUrl : '/' + product.imageUrl}`;
                              ...
                              if (product.images) {
                                ...
                                if (Array.isArray(imgs) && imgs.length > 0) {
                                  ...
                                  if (firstImage && firstImage.path) {
                                    const fullUrl = `http://192.168.56.83:5000${firstImage.path}`;
